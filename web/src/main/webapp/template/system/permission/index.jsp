...
BUI.use(['bui/ux/crudgrid'],function (CrudGrid) {
	...
	<framwork:crudPermission resource="/system/permission"/>
    ...
    var crudGrid = new CrudGrid({
    	entityName : '权限',
      	storeUrl : '${ctx}/system/permission/list',
         addUrl : '${ctx}/system/permission/add',
         updateUrl : '${ctx}/system/permission/update',
         removeUrl : '${ctx}/system/permission/del',
         columns : columns,
         showAddBtn : add,
