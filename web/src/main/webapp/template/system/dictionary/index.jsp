...
BUI.use(['bui/tree','bui/data','bui/toolbar','bui/select','bui/ux/crudgrid','bui/mask','bui/list'],
	...
	<framwork:crudPermission resource="/system/dictionary"/>
			...
			var gridStore;//
			 ...
			 var listStore = new Data.Store({
				  url : '${ctx}/system/dictionaryType/listAll',
				  autoLoad : true
			 });
		     ...
		     list.on('itemclick', function(ev){
		    	 ...
		    	 gridStore.load({'search_EQ_id' : ev.item.value});
	        ...
	        var bar = new Toolbar.Bar({
	         ...
	         var crudGrid = new CrudGrid({
	        	 gridId :'grid',
	         	 entityName : '资源',
	         	 storeUrl : '${ctx}/system/dictionary/list',
	            addUrl : '${ctx}/system/dictionary/add',
	            updateUrl : '${ctx}/system/dictionary/update',
	            removeUrl : '${ctx}/system/dictionary/del',
	            columns : columns,
	            showAddBtn : add,
	         ...
	         crudGrid.on('beforeAddShow', function(dialog,form){
	        	 if(!dictionaryTypeId){//dictionaryTypeId==0
	        		 ...
	        		 form.getField('id').set('value',dictionaryTypeId);
	        	 }
	         });
	         
	         crudGrid.on('beforeUpdateShow', function(dialog,form,record){ 
	        	 form.getField('id').set('value',record.dictionaryType.id);
	         });
