        ...
        <div class="row">
            ...
            <div class="control-group span_width">
                ...
                <div class="controls bui-form-group height_auto" data-rules="{dateRange : true}">
                    ...
                    <input type="text" class="calendar" name="search_GTE_releaseTime" data-tip="{text : '开始日期'}">
                    <span>
             - </span><input name="search_LTE_releaseTime" type="text" class="calendar" data-tip="{text : '结束日期'}">
                </div>
            </div>
