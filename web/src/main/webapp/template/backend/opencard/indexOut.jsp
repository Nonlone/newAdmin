...
function openout(id) {
    window.open('${IP}'+'${ctx}/admin/card/card/detail/'+id);
}
...
BUI.use(['bui/ux/crudgrid','bui/common/search','bui/common/page'],function (CrudGrid,Search,Grid) {
    ...
    var	ViewBtn = true;
    var	detailUrl = "${ctx}/admin/card/card/detail/";
    ...
    <framwork:crudPermission resource="/admin/card/card"/>
    ...
    var crudGrid = new CrudGrid({
        ...
        pkColumn : 'id',//主键
        storeUrl : '${ctx}/admin/card/card/listOut',
        addUrl : '${ctx}/admin/card/card/add',
        updateUrl : '${ctx}/admin/card/card/update',
        removeUrl : '${ctx}/admin/card/card/del',
        columns : columns,
        showAddBtn : add,
        ...
        operationColumnRenderer : function(value, obj){//操作列最追加按钮
            ...
            if(ViewBtn&&obj.idcard!=null){
                if(${isOut}){
                    viewStr = '<span title="'+obj.idcard.name+'详细信息'+'"><i class="icon-user"  onclick="openout('+id+');"></i></span>';
                }else{
