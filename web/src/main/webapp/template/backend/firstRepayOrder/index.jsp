...
<script type="text/javascript">
    ...
    var columns = [
        {title:'用户ID',dataIndex:'id',width:'8%'},
        {title:'客户姓名',dataIndex:'idCard',width:"8%",renderer: function (value) {
                if(value){
                    return value.name;
                }else{
                    return '';
        ...
        {title:'贷款金额',dataIndex:'loanOrder',width:'8%',renderer:function (value) {
			 if(value){
        ...
        {title:'首个还款日',dataIndex:'dueDate',width:'8%',renderer:BUI.Grid.Format.dateRenderer},
        {title:'首期总费用',dataIndex:'amount',width:'8%',renderer:function (value) {
			 if(value){
			     return value.amount;
			 }else{
				 return '';
        ...
        {title:"评审费",dataIndex:"",width:"8%"},
        {title:"担保费",dataIndex:"",width:"8%"},
        {title:"本息",dataIndex:"",width:"8%"},
        {title:"资金方",dataIndex:"",width:"8%"},
	...
	var crudGrid = new CrudGrid({
		entityName : '还款列表',
    	pkColumn : 'id',//主键
      	storeUrl : '${ctx}/backend/loan/firstRepayOrder/list',
        columns : columns,
		showAddBtn : add,
