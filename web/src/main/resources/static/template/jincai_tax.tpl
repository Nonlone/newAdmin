...
<div style="margin:10px auto;padding-left:20px;padding-top:10px;">
    ...
    <div>
        ...
        <div>
            <h1 style="display:inline-block;margin-right:10px;">纳税人基本信息</h1>
        </div>
        ...
        <div style="display:table;border-collapse:collapse;border:1px solid #ccc;width: 900px;">
            <div class="table-row-group">
                <ul class="table-row">
                    ...
                    <li class="table-cell">{{tax.jbxx.baseinfoVo.qyxz}}</li>
                    <li class="table-cell">注册地邮政编码</li>
                    <li class="table-cell">{{tax.jbxx.baseinfoVo.zcdyzbm}}</li>
                    <li class="table-cell">注册登记机关</li>
                    <li class="table-cell">{{tax.jbxx.baseinfoVo.djjg}}</li>
                </ul>
            </div>
            <div class="table-row-group">
                <ul class="table-row">
                    <li class="table-cell">开业日期</li>
                    <li class="table-cell">{{tax.jbxx.baseinfoVo.clrq}}</li>
                    <li class="table-cell">营业期限</li>
                    <li class="table-cell">{{tax.jbxx.baseinfoVo.yyqx}}</li>
                    <li class="table-cell">经营范围</li>
                    <li class="table-cell">{{tax.jbxx.baseinfoVo.jyfw}}</li>
                </ul>
            </div>
            <div class="table-row-group">
                <ul class="table-row">
                    <li class="table-cell">主管税务机关</li>
                    <li class="table-cell">{{tax.jbxx.baseinfoVo.zgswjg}}</li>
                    <li class="table-cell">纳税信用等级</li>
                    <li class="table-cell">{{tax.jbxx.baseinfoVo.pjjg}}</li>
                    <li class="table-cell">纳税人识别号</li>
                    <li class="table-cell">{{tax.jbxx.baseinfoVo.nsrsbh}}</li>
                </ul>
            </div>
            <div class="table-row-group">
                <ul class="table-row">
                    <li class="table-cell">纳税人状态</li>
                    <li class="table-cell">{{tax.jbxx.baseinfoVo.nsrzt}}</li>
                    <li class="table-cell">纳税类型</li>
                    <li class="table-cell">{{tax.jbxx.baseinfoVo.nsrzglx}}</li>
                    <li class="table-cell">法人姓名</li>
                    <li class="table-cell">{{tax.jbxx.baseinfoVo.frxm}}</li>
                </ul>
            </div>
            <div class="table-row-group">
                <ul class="table-row">
                    <li class="table-cell">担任法人区间(月)</li>
                    <li class="table-cell">{{tax.jbxx.baseinfoVo.drfrqj}}</li>
                    <li class="table-cell">股东信息</li>
                    <li class="table-cell">
                        {{each tax.jbxx.shareholderVoList}}
    ...
    <div>
        <div>
            <h1 style="display:inline-block;margin-right:10px;">主要财务数据</h1>
        </div>
        <div style="display:table;border-collapse:collapse;border:1px solid #ccc;width: 900px;">
    ...
    <div>
        <div>
            <h1 style="display:inline-block;margin-right:10px">历年发票数据汇总</h1>
        </div>
        {{each tax.qyfpsj.qyfpxxList}}
        <div>
            <h2>年份：{{value.nd}}</h2>
            <div class="table-row-group">
                <ul class="table-row">
    ...
    <div>
        <div>
            <h1>历年其他重要支出数据明细</h1><span>（根据查询记录分析）</span>
        </div>
        {{each tax.qyfpsj.qyfpxxList}}
        <div>
            <h2>年份：{{value.nd}}</h2>
    ...
    <div>
        <div>
            <h1 style="display:inline-block;margin-right:10px;">纳税情况汇总</h1>
        </div>
        {{each tax.nszsxx.ndQyZsxxVoList}}
        <div>
            <h2>年份：{{value.nd}}</h2>
            <div class="table-row-group">
                <ul class="table-row">
