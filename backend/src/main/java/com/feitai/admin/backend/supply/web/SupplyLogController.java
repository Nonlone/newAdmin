...
public class SupplyLogController extends BaseListableController<SupplyLogMore> {
    ...
    public Object listPage(ServletRequest request) {
        ...
        List<SupplyLogMore> resultList = getService().findAllBySqls(getCommonSqls(request,getSelectMultiTable().buildSqlString()+ " ORDER BY " + SelectMultiTable.MAIN_ALAIS + ".created_time DESC"), pageNo, pageSize);
